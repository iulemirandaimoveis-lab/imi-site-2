                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-3">
                            <select
                                ...
                                className="w-full sm:w-auto px-4 py-2 border-2 border-neutral-200 rounded-xl focus:border-primary-500 focus:ring-4 focus:ring-primary-100 transition-all outline-none bg-white"
                            >
                            ...
                            <button className="w-full sm:w-auto px-4 py-2 bg-primary-700 text-white rounded-xl hover:bg-primary-800 transition-colors font-medium">
                                Exportar PDF
                            </button>
                        </div>
                    </div>
