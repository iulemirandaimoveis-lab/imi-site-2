                                            ...
                                            >
                                                <div className="rounded-xl overflow-hidden bg-white border border-slate-100 shadow-soft hover:shadow-card-hover transition-all duration-300">
                                                    ...
                                                    <div className="p-5 sm:p-6">
                                                        ...
                                                        <h3 className="font-display text-lg sm:text-xl font-bold text-imi-900 mb-2 line-clamp-1">
                                                            {dev.name}
                                                        </h3>
                                                        ...
                                                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 sm:gap-4">
                                                            <div>
                                                                ...
                                                                <div className="font-display text-xl sm:text-2xl font-bold text-imi-900">
