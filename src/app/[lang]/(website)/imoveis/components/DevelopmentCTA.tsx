            ...
            <div className="container-custom relative z-10">
                ...
                >
                    <motion.h2 variants={slideUp} className="font-display text-4xl md:text-5xl lg:text-6xl mb-6 font-bold tracking-tight">
                        Interessado neste <span className="text-gold-500 italic">ativo?</span>
                    </motion.h2>
                    <motion.p variants={slideUp} className="text-slate-300 text-lg md:text-xl mb-12 font-light max-w-2xl mx-auto leading-relaxed">
                    ...
                    <motion.div variants={slideUp} className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                        <Button
                            size="lg"
                            className="bg-white text-navy-900 hover:bg-slate-100 min-w-[280px] h-16 font-bold uppercase tracking-[0.2em] text-sm shadow-xl"
