        ...
        <main className="bg-white">
                ...
                <div className="container-custom relative z-10">
                    <div className="max-w-3xl">
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-accent-500 font-semibold uppercase tracking-[0.2em] text-xs">Projetos</span>
                        </div>
                        ...
                        <p className="text-imi-300 text-lg md:text-xl font-light leading-relaxed max-w-2xl">
                            Portfólio de projetos de investimento e desenvolvimento imobiliário.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="section-padding">
                <div className="container-custom text-center">
                    ...
                    <Link href="/pt/contato" className="text-accent-600 font-semibold hover:underline">
                        Solicite acesso ao portfólio completo →
                    </Link>
                </div>
            </section>
        </main>
